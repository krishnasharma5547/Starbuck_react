...
export default function HeroSection() {
  let link = "#";
  return (
      <div class="flex md:flex-row flex-col bg-back  -z-1">
        <div class="px-12 py-9  text-center md:text-normal md:mt-56 xl:mt-80 md:text-justify">
          ...
          <Button
              link="#"
              classes="bg-primary-400 text-white font-medium text-base"
          >
            join now
          </Button>
        ...
        <div className="w-full flex-1 xl:mt-32">
